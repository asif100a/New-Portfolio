        ...
        <footer className="footer footer-center bg-[#0d1117] text-white gradient-horizontal text-base-content rounded p-3 sm:p-10">
            ...
            <nav>
                <div className="flex gap-6 justify-center items-center">
                    <a href="https://www.linkedin.com/in/n-m-asif-sheikh" target="_blank" rel="noreferrer">
                        <CiLinkedin className="w-8 h-8 text-blue-500" />
                    </a>
                    <a href="https://github.com/asif100a" target="_blank" rel="noreferrer">
                        <VscGithub className="w-7 h-7 text-purple-500" />
                    </a>
                    <a href="https://www.facebook.com/profile.php?id=100070024600518" target="_blank" rel="noreferrer">
                        <LiaFacebook className="w-9 h-9 text-indigo-500" />
                    </a>
                    <a href="https://wa.link/l3yb8x" target="_blank" rel="noreferrer">
