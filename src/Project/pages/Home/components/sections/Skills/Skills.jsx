            ...
            <div className="mx-auto max-w-6xl">
                ...
                <StaggerGroup className="mt-8 grid gap-5 lg:grid-cols-3">
                    {skillGroups.map((group) => (
                        <MotionCard key={group.title} className="rounded-[1.75rem] border border-white/10 bg-white/5 p-6 shadow-[0_20px_60px_rgba(2,8,20,0.22)]">
                ...
                <div className="mt-6 grid gap-5 lg:grid-cols-3">
                    <MotionCard className="rounded-[1.75rem] border border-white/10 bg-slate-950/45 p-6 lg:col-span-2">
                    ...
                    <MotionCard className="rounded-[1.75rem] border border-white/10 bg-white/5 p-6">
